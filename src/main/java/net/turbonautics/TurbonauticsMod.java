...
@Mod("turbonautics")
public class TurbonauticsMod {
	public static final Logger LOGGER = LogManager.getLogger(TurbonauticsMod.class);
	public static final String MODID = "turbonautics";

	public TurbonauticsMod(IEventBus modEventBus) {
